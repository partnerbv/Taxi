...
export default function FloatingCTA() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Hide on hero (first screen) and footer (last 400px)
      const isOnHero = scrollTop < windowHeight * 0.8
      const isOnFooter = scrollTop + windowHeight > documentHeight - 400

      setIsVisible(!isOnHero && !isOnFooter)
    }
  ...
  return (
    <div className="fixed bottom-6 left-4 right-4 z-50 lg:hidden animate-fade-in">
