      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Enjoy Taxi diensten - Mercedes EQS bij het Binnenhof in Den Haag"
            fill
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">
              Onze Taxi Diensten
              <span className="block text-gradient-blue">Den Haag & Leiden</span>
            </h1>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="https://wa.me/31620172767" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-5 py-2.5 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition-colors">
