...
const airportPrices = [
  { airport: 'Schiphol Airport', code: 'AMS', price: 79, duration: '45 min' },
  { airport: 'Rotterdam Airport', code: 'RTM', price: 55, duration: '25 min' },
  { airport: 'Eindhoven Airport', code: 'EIN', price: 149, duration: '90 min' },
]
...
export async function generateMetadata({ params }: LocationPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      locale: 'nl_NL',
      images: [{ url: 'https://enjoytaxi.nl/taxi-vredespaleis.webp', width: 1200, height: 630, alt: `Taxi ${location.name}` }],
    },
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt={`Taxi ${location.name} - Enjoy Taxi Mercedes EQS bij het Vredespaleis in Den Haag`}
            fill
            ...
            <div className="lg:col-span-3">
              ...
              <div className="relative overflow-hidden rounded-2xl">
                <Image
                  ...
                  alt={`Taxi service ${location.name} - Enjoy Taxi Mercedes EQS in Den Haag`}
                  width={600}
                  height={400}
                ...
                <div className="bg-gradient-to-br from-secondary-900 to-secondary-800 rounded-3xl p-8 text-white shadow-2xl">
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-3 w-full py-4 bg-green-600 text-white font-bold rounded-xl transition-all hover:bg-green-700 hover:scale-[1.02]"
                    >
