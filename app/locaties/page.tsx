          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {denHaagOmgeving.map((location) => (
              <Link
                key={location.slug}
                href={`/${location.slug}`}
                className="group p-6 bg-white rounded-xl border border-secondary-200 hover:border-primary-200 hover:shadow-lg transition-all text-center"
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {leidenRegion.map((location) => (
              <Link
                key={location.slug}
                href={`/${location.slug}`}
                className="group p-6 bg-secondary-50 rounded-xl border border-secondary-200 hover:border-primary-200 hover:shadow-lg transition-all text-center"
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
          ...
          <div className="max-w-4xl mx-auto bg-secondary-50 rounded-3xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center px-8 py-4 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-all shadow-lg"
              >
