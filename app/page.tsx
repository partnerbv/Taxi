        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-secondary-900 mb-6">
                Taxi Den Haag, Leiden & Schiphol
              </h2>
              <p className="text-lg text-secondary-600 mb-8">
                Premium taxi service in heel Zuid-Holland. Van Den Haag tot Leiden, van Scheveningen tot Schiphol - wij rijden overal.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center p-4 bg-white rounded-xl border border-secondary-200">
                  <div className="text-2xl font-bold text-primary-600">€79</div>
                  <div className="text-sm text-secondary-500">Schiphol</div>
                </div>
              </div>
